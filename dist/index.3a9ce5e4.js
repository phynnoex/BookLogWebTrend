...
})({"exjNl":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "053839de3a9ce5e4";
"use strict";
...
},{}],"js0LU":[function(require,module,exports,__globalThis) {
var _firebaseConfigJs = require("../js/firebaseConfig.js"); // Import the Firestore database instance
...
function ruleChatBot(request) {
    if (request.startsWith("add task")) {
        ...
        if (bookDetails) {
            ...
            } else appendMessage("Please follow the format: 'add book title, author, genre, rating'");
            (0, _scriptJs.displayBooks)((0, _scriptJs.currentSort), (0, _scriptJs.uniqueCategory));
        } else // If no details, prompt user with the template
        appendMessage("Use this template to add a book: 'add book title, author, genre, rating'");
        return true;
    }
...
aiButton.addEventListener("click", async ()=>{
    ...
    if (prompt) {
        ...
        if (!ruleChatBot(prompt)) await askChatBot(prompt);
    } else appendMessage("Please enter a prompt", true); // Adding user message
});
...
},{"../js/firebaseConfig.js":"iGlw8","firebase/firestore":"8A4BC","@google/generative-ai":"gKJrW","./script.js":"4pp4s"}],"gKJrW":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["exjNl","js0LU"], "js0LU", "parcelRequire94c2")

//# sourceMappingURL=index.3a9ce5e4.js.map
