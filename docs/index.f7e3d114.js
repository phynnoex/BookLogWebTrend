!function(e,t,n,o,s){var i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a="function"==typeof i[o]&&i[o],r=a.cache||{},l="undefined"!=typeof module&&"function"==typeof module.require&&module.require.bind(module);function d(t,n){if(!r[t]){if(!e[t]){var s="function"==typeof i[o]&&i[o];if(!n&&s)return s(t,!0);if(a)return a(t,!0);if(l&&"string"==typeof t)return l(t);var c=Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}f.resolve=function(n){var o=e[t][1][n];return null!=o?o:n},f.cache={};var u=r[t]=new d.Module(t);e[t][0].call(u.exports,f,u,u.exports,i)}return r[t].exports;function f(e){var t=f.resolve(e);return!1===t?{}:d(t)}}d.isParcelRequire=!0,d.Module=function(e){this.id=e,this.bundle=d,this.exports={}},d.modules=e,d.cache=r,d.parent=a,d.register=function(t,n){e[t]=[function(e,t){t.exports=n},{}]},Object.defineProperty(d,"root",{get:function(){return i[o]}}),i[o]=d;for(var c=0;c<t.length;c++)d(t[c]);if(n){var u=d(n);"object"==typeof exports&&"undefined"!=typeof module?module.exports=u:"function"==typeof define&&define.amd&&define(function(){return u})}}({fOCBn:[function(e,t,n,o){var s,i,a=e("../js/firebaseConfig.js"),r=e("firebase/firestore"),l=e("@google/generative-ai"),d=e("./script.js");let c=document.getElementById("send-btn"),u=document.getElementById("chat-input"),f=document.getElementById("chat-history");async function h(){try{s=(await (0,r.getDoc)((0,r.doc)(a.db,"apiKey","googlegenai"))).data().key,console.log("API Key:",s),i=new l.GoogleGenerativeAI(s).getGenerativeModel({model:"gemini-1.5-flash"})}catch(e){console.error("Error getting API key:",e),g("Failed to initialize AI.")}}function g(e,t=!1){let n=document.createElement("div");n.textContent=e,n.className=t?"user-history":"ai-history",f.appendChild(n),u.value=""}async function p(e){g((await i.generateContent(e)).response.text())}c.addEventListener("click",async()=>{let e=u.value.trim().toLowerCase();e?(g(e,!0),!function(e){if(e.startsWith("add task")){let t=e.replace("add task","").trim();return t?g("Task "+t+" added!",!0):g("Please specify a task to add.",!0),!0}if(e.startsWith("add book")){let t=e.replace("add book","").trim();if(t){let e=t.split(",").map(e=>e.trim());if(4===e.length){let t=e[0],n=e[1],o=e[2],s=e[3];(0,d.addBook)(t,n,o,s).then(()=>{console.log("Book added successfully"),g(`Book added! Title: ${t}, Author: ${n}, Genre: ${o}, Rating: ${s}`)}).catch(e=>{console.error("Error adding book:",e)})}else g("Please follow the format: 'add book title, author, genre, rating'");(0,d.displayBooks)(d.currentSort,d.uniqueCategory)}else g("Use this template to add a book: 'add book title, author, genre, rating'");return!0}return!1}(e)&&await p(e)):g("Please enter a prompt",!0)}),u.addEventListener("keypress",function(e){"Enter"===e.key&&c.click()}),window.addEventListener("load",async()=>{await h()})},{"../js/firebaseConfig.js":"ciChV","firebase/firestore":"59KHr","@google/generative-ai":"2jUEE","./script.js":"anU40"}],"2jUEE":[function(e,t,n,o){var s,i,a,r,l,d,c,u,f,h,g,p,E,m,C,y,O,v,I,_,T,A,N,R,S=e("@parcel/transformer-js/src/esmodule-helpers.js");S.defineInteropFlag(n),S.export(n,"BlockReason",()=>I),S.export(n,"ChatSession",()=>en),S.export(n,"DynamicRetrievalMode",()=>N),S.export(n,"ExecutableCodeLanguage",()=>m),S.export(n,"FinishReason",()=>_),S.export(n,"FunctionCallingMode",()=>A),S.export(n,"GenerativeModel",()=>ea),S.export(n,"GoogleGenerativeAI",()=>er),S.export(n,"GoogleGenerativeAIError",()=>w),S.export(n,"GoogleGenerativeAIFetchError",()=>x),S.export(n,"GoogleGenerativeAIRequestInputError",()=>L),S.export(n,"GoogleGenerativeAIResponseError",()=>M),S.export(n,"HarmBlockThreshold",()=>O),S.export(n,"HarmCategory",()=>y),S.export(n,"HarmProbability",()=>v),S.export(n,"Outcome",()=>C),S.export(n,"POSSIBLE_ROLES",()=>b),S.export(n,"SchemaType",()=>E),S.export(n,"TaskType",()=>T),(s=E||(E={})).STRING="string",s.NUMBER="number",s.INTEGER="integer",s.BOOLEAN="boolean",s.ARRAY="array",s.OBJECT="object",(i=m||(m={})).LANGUAGE_UNSPECIFIED="language_unspecified",i.PYTHON="python",(a=C||(C={})).OUTCOME_UNSPECIFIED="outcome_unspecified",a.OUTCOME_OK="outcome_ok",a.OUTCOME_FAILED="outcome_failed",a.OUTCOME_DEADLINE_EXCEEDED="outcome_deadline_exceeded";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function V(e,t,n,o){return function(e){let[t,n]=(function(e){let t=e.getReader();return new ReadableStream({start(e){let n="";return function o(){return t.read().then(({value:t,done:s})=>{let i;if(s){if(n.trim()){e.error(new w("Failed to parse stream"));return}e.close();return}let a=(n+=t).match(q);for(;a;){try{i=JSON.parse(a[1])}catch(t){e.error(new w(`Error parsing JSON response: "${a[1]}"`));return}e.enqueue(i),a=(n=n.substring(a[0].length)).match(q)}return o()})}()}})})(e.body.pipeThrough(new TextDecoderStream("utf8",{fatal:!0}))).tee();return{stream:function(e){return function(e,t,n){if(!Symbol.asyncIterator)throw TypeError("Symbol.asyncIterator is not defined.");var o,s=n.apply(e,t||[]),i=[];return o={},a("next"),a("throw"),a("return"),o[Symbol.asyncIterator]=function(){return this},o;function a(e){s[e]&&(o[e]=function(t){return new Promise(function(n,o){i.push([e,t,n,o])>1||r(e,t)})})}function r(e,t){try{var n;(n=s[e](t)).value instanceof Y?Promise.resolve(n.value.v).then(l,d):c(i[0][2],n)}catch(e){c(i[0][3],e)}}function l(e){r("next",e)}function d(e){r("throw",e)}function c(e,t){e(t),i.shift(),i.length&&r(i[0][0],i[0][1])}}(this,arguments,function*(){let t=e.getReader();for(;;){let{value:e,done:n}=yield Y(t.read());if(n)break;yield yield Y(F(e))}})}(t),response:J(n)}}(await H(t,R.STREAM_GENERATE_CONTENT,e,!0,JSON.stringify(n),o))}async function W(e,t,n,o){let s=await H(t,R.GENERATE_CONTENT,e,!1,JSON.stringify(n),o);return{response:F(await s.json())}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eo(e,t,n,o){return(await H(t,R.COUNT_TOKENS,e,!1,JSON.stringify(n),o)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function es(e,t,n,o){return(await H(t,R.EMBED_CONTENT,e,!1,JSON.stringify(n),o)).json()}async function ei(e,t,n,o){let s=n.requests.map(e=>Object.assign(Object.assign({},e),{model:t}));return(await H(t,R.BATCH_EMBED_CONTENTS,e,!1,JSON.stringify({requests:s}),o)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=index.f7e3d114.js.map
